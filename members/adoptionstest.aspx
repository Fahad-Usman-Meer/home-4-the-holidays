...
if session("UserId")="" then response.Redirect("../login.aspx?ReturnURL=../home4theholidays/members/adoptions.aspx")
	...
	if page.isvalid then
		...
		dim strAType as string
			...
			if strResult="" then 'does not exist-insert new
				strSql="INSERT Into tblH4thAdoptions (ShelterID, DateID, Ayear, AType, Dogs, Puppies, Cats, Kittens, Other) Values (" & session("UserId") & "," & ddlDates.selecteditem.value & ",'2012','" & strAType & "'," & tbDogs.text & "," & tbPuppies.text & "," & tbCats.text & "," & tbKittens.text & "," & tbOther.text & ")"
			else 'exists, update
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitle" Runat="Server" >IH4TH Members</asp:content>
...
<h1 class="grn_ttl_blg">Recording Adoptions For Your Shelter<br></h1><div class="feature">
		...
		<asp:Panel runat="server"  BorderColor="#006600" BackColor="#EAEEEC" BorderStyle="Ridge" BorderWidth="1">
		 ...
		 <table cellpadding="4" cellspacing="4" >
            ...
            <tr>
              <td colspan="6"><asp:Button runat="server" OnClick="btnAdd_Adoptions_Click" Text="Submit Numbers" BackColor="#006600" ForeColor="#FFFFFF" BorderStyle="none"  Font-Bold="true"/></td>
            </tr>
          </table>
		</form></asp:Panel>
