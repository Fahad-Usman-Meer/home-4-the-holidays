...
sub page_load (obj as object, e as eventargs)
	...
	'Use when voting is closed
		...
		Dim date2 As Date = "2/11/2015 5:00pm"
		...
		if result>0 then 'later
			...
			if request.QueryString("verify")<>"" then 'for verification
				isql="UPDATE tblIH4THEssay_Votes_2015 SET Verified=1, Verification_ip='" & request.ServerVariables("REMOTE_ADDR") & "', Verification_date='" & datetime.now() & "' where UniqueID='" & request.QueryString("verify") & "'"
...
<h1 class="grn_ttl_blg">Vote For Your Favorite Heartwarming Adoption Story!<br>
														  ...
														  <div align="left">
                                                            ...
                                                            <p>One lucky pet adoption organization, participating in this  year&rsquo;s Blue Buffalo Home 4 the Holidays campaign, will receive <strong>$1,000</strong> for their adoption story – <strong>and it all depends on YOU! </strong></p>
                                                              <p>                                                                This year, we have 12 finalists, each one with a story that  will tug at your heartstrings. <strong>You&rsquo;ll  meet pets who survived unbelievable circumstances and the organizations who  never gave up on them.</strong><br>
  <strong>Voting Guidelines</strong></p>
                                                              <ul>
                                                                <li>Voting begins Tuesday, 2/3/2015, at 10 a.m. and  ends 2/11/2015, at 5 p.m. (all times PDT)</li>
                                                                <li>Only one vote per email, so make it count!</li>
                                                                <li>You will be sent a validation email to confirm  your vote, <strong>so please check your email to  ensure your vote counts.</strong></li>
                                                            </ul>
                                                              <p>Please read through each story to see how our Home 4 the  Holidays partner organizations are going above and beyond for orphan pets. </p>
<p>
                              ...
                              <form runat="server" id="form1"> <table width="100%" border="0" cellspacing="3" cellpadding="3">
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote1" runat="server" Text="0"  CssClass="votes"/>
                                                                    <br />
                                                                  votes</td>
                                                                  <td valign="middle"><a href="stories-2015/abbott-costello.aspx" target="_blank"><img src="_images/Stories-2016/1 - Abbott and Costello/Abbott and Costello - Story Contest-4 - Copy.jpg" width="200" height="200" /> </a></td>
...
These were some of the most shocking photos of animal  cruelty we&rsquo;ve ever seen: two kittens plastered in foam insulation and left in  the street to die. The story made headlines, causing outrage and the community  to rally around the kittens. Shelter staff worked round-the-clock to nurse  Abbott and Costello back to health before placing them with the perfect pet  parents. </p>
                                                                    <p><a href="stories-2015/abbott-costello.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote2" runat="server" Text="0" CssClass="votes"/>
                                                                    <br />
                                                                  votes</td>
                                                                  <td><a href="stories-2015/almond-joy.aspx" target="_blank"><img src="_images/Stories-2016/2 - Almond Joy/Almond Joy - Heartwarming Story Contest-1 - Copy.jpg" width="200" height="200" /></a></td>
                                                                  <td><p><strong>Almond Joy</strong><br>
                                                                    ...
                                                                    <p><a href="stories-2015/almond-joy.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
...
After being rescued, Boone was off to the Big House. That&rsquo;s  right: he moved into a prison, where inmates trained him to open doors, turn on  lights, pick up things and more. Now, he is a proud service dog for a young man  with Cerebral Palsy. </p>
                                                                   <p><a href="stories-2015/boone.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote4" runat="server" Text="0" CssClass="votes"/>
                                                                    <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/booth.aspx" target="_blank"><img src="_images/Stories-2016/4 - Booth/Boothe - Heartwarming Story Contest-1 - Copy.jpg" width="200" height="200" /></a></td>
                                                                  <td><p><strong>Booth </strong><br>
[EMBED PHOTO: Booth – Heartwarming  Story Contest-1.jpg]<br>
Be warned, Booth&rsquo;s story is a tearjerker. A war veteran,  beaten down by life, came to the shelter &ldquo;just to look.&rdquo; He ended up find the  perfect dog, but didn&rsquo;t have enough money to cover the fees. Shelter staff  decided they would do whatever it took to make this adoption happen. The vet&rsquo;s  reaction will melt your heart.</p>
                                                                    <p><a href="stories-2015/booth.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote5" runat="server" Text="0"  CssClass="votes"/>                                                                
                                                                      <br />
                                                                    votes</td>
                                                                  <td valign="middle"><a href="stories-2015/brownie.aspx" target="_blank"><img src="_images/Stories-2016/5 - Brownie/Brownie - Heartwarming Story Contest-2 - Copy.jpg" width="200" height="200" /></a></td>
                                                                  <td><p><strong>Brownie</strong></p>
                                                                    ...
                                                                    <p><a href="stories-2015/brownie.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote6" runat="server" Text="0" CssClass="votes"/>                                                                
                                                                      <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/bruce-wayne.aspx" target="_blank"><img src="_images/Stories-2016/6 - Bruce Wayne/Bruce Wayne - Heartwarming Story Contest-6-2.jpg" width="200" height="200" /></a></td>
...
Bruce Wayne was one of the most emaciated dogs we&rsquo;ve ever  seen. His original owner starved him <em>intentionally</em>,  and it almost killed him. When he arrived at the rescue, the vet only gave him  a 3 percent chance to live. Slowly but surely, he transformed into a sweet,  lovable pet, even prompting his forever family to become fosters themselves. </p>
                                                                    <p><a href="stories-2015/bruce-wayne.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote7" runat="server" Text="0" CssClass="votes"/>                                                                
                                                                      <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/buster-thor.aspx" target="_blank"><img src="_images/Stories-2016/7 - Buster and Thor/Buster and Thor - Heartwarming Story Contest-1 - Copy.jpg" width="200" height="200" /></a></td>
...
Buster and Thor&rsquo;s happy ending began with a bargain. In an  attempt to persuade her daughter to take Spanish instead of French, Annelise&rsquo;s  mom reluctantly agreed to let her adopt a kitten. When Annelise started  researching kitten adoption, she learned that kittens are better in pairs! This  family fell in love with the first pair they met. </p>
                                                                    <p><a href="stories-2015/buster-thor.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote8" runat="server" Text="0" CssClass="votes"/>                                                                
                                                                      <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/manny-ray.aspx" target="_blank"><img src="_images/Stories-2016/8 - Manny and Ray/Manny and Ray - Heartwarming Story Contest-3 - Copy.jpg" width="200" height="200" /></a></td>
...
Kittens Ray and Manny were rescued from separate litters  during two &ldquo;Trap, Neuter, Release&rdquo; missions. Ray suffered my eye infections so  severe that both his eyes had to be removed. Manny was healthy, but after every  single one of his littermates was adopted, the shy kitten was left all alone.  Together, they found the perfect home with a  mom and sweet 8-year-old girl with special needs. </p>
                                                                    <p><a href="stories-2015/manny-ray.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote9" runat="server" Text="0"  CssClass="votes"/>                                                                
                                                                      <br />
                                                                    votes</td>
                                                                  <td valign="middle"><a href="stories-2015/milton.aspx" target="_blank"><img src="_images/Stories-2016/9 - Milton/Milton - Heartwarming Story Contest-2 - Copy.jpg" width="200" height="200" /></a></td>
...
When Milton first arrived to his foster home, he was so sick  that all he could do was sleep. Eventually, his sweet, lovable spirit shone  through.  He loved the large dogs in his  foster home, so &ldquo;big doggie siblings&rdquo; were put on his forever home wish list.  He would get his wish, but it was take a long journey up the East Coast.</p>
                                                                    <p><a href="stories-2015/milton.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote10" runat="server" Text="0" CssClass="votes"/>                                                                
                                                                      <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/pink.aspx" target="_blank"><img src="_images/Stories-2016/10 - Pink/Pink - Heartwarming Story Contest-6 - Copy.jpg" width="200" height="200" /></a></td>
...
It&rsquo;s no wonder Pink wasn&rsquo;t trusting of humans. She lived  underneath vehicles in an old car lot, fending for herself and her seven  kittens. A Good Samaritan started feeding the feline family and was eventually able  to bring them shelter. Her adorable kittens were adopted in a snap, but Pink  was too scared to show adopters her true personality. She was transferred to  foster care where she learned to play and snuggle (albeit it one paw at the  time.) Pink is so loved by her new family!</p>
                                                                    <p><a href="stories-2015/pink.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote11" runat="server" Text="0" CssClass="votes"/>                                                                  
                                                                    <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/pirate.aspx" target="_blank"><img src="_images/Stories-2016/11 - Pirate/Pirate - Heartwarming Story Contest-2 - Copy.jpg" width="200" height="200" /></a></td>
...
Pirate lived at the shelter for <em>seven</em> years. He was a beautiful collie, but always became shy and  standoffish when adopters came through. Meanwhile, Gerrie and her husband had  just suffered the heartbreaking loss of two collies. Pirate didn&rsquo;t make the  best first impression on the couple, but shelter staff encouraged them to have  faith. He has absolutely blossomed in his new home!</p>
                                                                    <p><a href="stories-2015/pirate.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  ...
                                                                  <td align="center"><asp:Label ID="lblVote12" runat="server" Text="0" CssClass="votes"/>                                                                  
                                                                    <br />
                                                                    votes</td>
                                                                  <td><a href="stories-2015/william.aspx" target="_blank"><img src="_images/Stories-2016/12 - William/William - Heartwarming Story Contest-1 - Copy.jpg" width="200" height="200" /></a></td>
...
<p><a href="stories-2015/william.aspx" target="_blank">--&gt;Full Story</a></p></td>
                                                                </tr>
                                                                <tr>
                                                                  <td>&nbsp;</td>
                                                                  <td colspan="4">&nbsp;</td>
