<% @ Page Language="VB" MasterPageFile="~/template.master" Title="Blue Buffalo Home 4 the Holidays Campaign | Helen Woodward Animal Center" debug="false" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
  <meta name="description" content="Blue Buffalo Home 4 the Holidays is the largest pet adoption campaign in the world. Learn more about the campaign and its mission of ending puppy mill sales." />
...
<h1 class="grn_ttl_blg">Keep the Light Shining with Blue Buffalo Home 4 the Holidays…<br>
</h1>
<div class="feature">
