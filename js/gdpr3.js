...
function loadBingTrackingScript() {
    var script = document.createElement('script');
    script.id = 'loadBingTrackingScript';
    script.type = 'text/javascript';
    script.text = `
                (function (w, d, t, r, u) {
                    var f, n, i;
    ...
    console.log('loaded "loadBingTrackingScript"');

    // Create and append the noscript element
    var noscript = document.createElement('noscript');
    noscript.innerHTML = '<img src="//bat.bing.com/action/0?ti=5280918&Ver=2" height="0" width="0" style="display: none; visibility: hidden;" />';
